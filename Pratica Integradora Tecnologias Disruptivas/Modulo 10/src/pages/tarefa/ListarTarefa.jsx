  ...
  return (
    <>
      ...
      <div>
        ...
        >
          <div>
            <CriarTarefa handleClose={handleClose} tarefas={tarefas} setTarefas={setTarefas} setOpenModal={setOpenModal} />
          </div>
        </Modal>
      </div>
      <div>
        ...
        <Dialog open={openModal}>
          <DialogTitle>Tarefa Criada</DialogTitle>
          <DialogContent>
            <DialogContentText>
              <p>Sua tarefa foi criada com sucesso!</p>
            </DialogContentText>
          </DialogContent>
          <DialogActions>
